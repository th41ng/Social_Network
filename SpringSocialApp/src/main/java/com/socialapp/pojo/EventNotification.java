...
@NamedQueries({
    @NamedQuery(name = "Notis.findAll", query = "SELECT n FROM EventNotification n"),
    @NamedQuery(name = "Notis.findForUser", query = "SELECT n FROM EventNotification n "
            + "WHERE (n.receiverUserId = :userId OR n.groupId IN :groupIds) ")
})
