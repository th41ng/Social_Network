...
const Login = () => {
    ...
    const login = async (e) => {
        ...
        try {
            ...
            if (ex.response) {
                // Phân loại lỗi và hiển thị thông báo tương ứng
                switch (ex.response.data) {
                    ...
                    case "notVerified":
                        setError(
                            "Tài khoản chưa được xác thực. Vui lòng kiểm tra email của bạn để kích hoạt tài khoản."
                        );
                        break;
                    case "expired":
                        setError(
                            <>
                                Mật khẩu của bạn đã hết hạn. Vui lòng đặt lại mật khẩu{" "}
                                <a
                                    href="/reset-password"
                                    style={{
                                        color: "blue",
